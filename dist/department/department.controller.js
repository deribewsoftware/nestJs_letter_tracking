...
let DepartmentController = class DepartmentController {
    ...
    create(organizationId, createDepartmentDto) {
...
__decorate([
    (0, permission_1.RequiredPermission)('canPostDepartment', 'canManageDepartment'),
    (0, common_1.Post)(':organizationId'),
...
__decorate([
    (0, permission_1.RequiredPermission)('canListDepartment'),
    (0, common_1.Get)(),
    __metadata("design:type", Function),
...
__decorate([
    (0, permission_1.RequiredPermission)('canDetailDepartment'),
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, permission_1.RequiredPermission)('canUpdateDepartment'),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, permission_1.RequiredPermission)('canDeleteDepartment'),
...
exports.DepartmentController = DepartmentController = __decorate([
    (0, permission_1.RequiredPermission)('canManageDepartment'),
